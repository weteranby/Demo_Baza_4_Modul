...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +++
	//Супонев А.А.: Вывод на Форму реквизита Юр.Адрес Контрагента
	ПолеРеквизита = Элементы.Вставить("САА_КонтактноеЛицо", Тип("ПолеФормы"),,Элементы.ИНН);
	ПолеРеквизита.Вид = ВидПоляФормы.ПолеВвода;
	ПолеРеквизита.ПутьКДанным = "Объект.САА_КонтактноеЛицо";
	// ---
